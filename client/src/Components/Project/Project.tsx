              ...
              <div className="project__cards">
                ...
                <Card className="project__card">
                  ...
                  <div className="project__card-inner">
                    ...
                    <div className="project__card-text">
                      <p className="project__card-text-desc">
                        A&nbsp;small app for practicing working with state and calculations. The user can &laquo;buy&raquo; cryptocurrency at&nbsp;any price and quantity, and then track how much he&nbsp;earned or&nbsp;lost.
                      </p>
                      <p className="project__card-text-technologies">
